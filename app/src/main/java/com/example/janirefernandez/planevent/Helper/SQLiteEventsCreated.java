...
public class SQLiteEventsCreated extends SQLiteOpenHelper {
    ...
    // Login table name
    private static final String TABLE_EVENT = "eventsCreated";
    ...
    public SQLiteEventsCreated(Context context, String databaseName) {
