        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password1.isEmpty() && !password2.isEmpty()) {
                    ...
                    if(new FunctionsHelper().checkMail(email)){
                        ...
                        if(password1.equalsIgnoreCase(password2))
                        {
                            ...
                            Toast.makeText(getApplicationContext(),
                                    getText(R.string.verifyPassword), Toast.LENGTH_LONG)
                                    .show();
                            inputPassword1.setError(getText(R.string.error_password));
                            inputPassword2.setError(getText(R.string.error_password));
                        }
                    }else{
                        inputEmail.setError(getText(R.string.error_email));
                    }
                } else {
                    Toast.makeText(getApplicationContext(),
                            getText(R.string.enterDetails), Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(), getText(R.string.registerSuccessfully), Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(getApplicationContext(),getText(R.string.error_connection), Toast.LENGTH_LONG).show();
                    }
